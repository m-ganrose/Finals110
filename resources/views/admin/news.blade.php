...
<section class="normal-breadcrumb set-bg bg-black   " data-setbg="../Sources/normal-breadcrumb.jpg">
    <div class="container-fluid position-relative">
        <img src="../Sources/normal-breadcrumb.jpeg" alt="" class="normal-breadcrumb-img img-fluid">
        <div class="row position-absolute w-100 h-100">
            <div class="col-lg-12 d-flex align-items-center justify-content-center">
                <div class="normal__breadcrumb__text text-center text-white">
                    <h2>ANIME NEWS</h2>
...
<!-- Blog Section Begin -->
<section class="blog spad bg-black">
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="blog__item set-bg" data-setbg="../Sources/blog/blog-1.jpg">
                            <img src="../Sources/blog/blog-1.jpg" alt=" " class="blog__item set-bg">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="blog__item small__item set-bg" data-setbg="img/blog/blog-4.jpg">
                            <img src="../Sources/blog/blog-4.jpg" alt=" " class="small__item set-bg">
                            <div class="blog__item__text">
                                <p><span class="icon_calendar"></span> 01 March 2020</p>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="blog__item small__item set-bg" data-setbg="img/blog/blog-5.jpg">
                            ...
                            <img src="../Sources/blog/blog-5.jpg" alt=" " class="small__item set-bg">
                    ...
                    <div class="col-lg-12">
                        <div class="blog__item set-bg" data-setbg="img/blog/blog-7.jpg">
                            ...
                            <img src="../Sources/blog/blog-7.jpg" alt=" " class="blog__item set-bg">
                            <div class="blog__item__text">
                                <p><span class="icon_calendar"></span> 01 March 2020</p>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="blog__item small__item set-bg" data-setbg="img/blog/blog-10.jpg">
                            <img src="../Sources/blog/blog-10.jpg" alt=" " class="blog__item small__item set-bg">
                            <div class="blog__item__text">
                                <p><span class="icon_calendar"></span> 01 March 2020</p>
                                <h4><a href="#">Fate/Stay Night: Untimated Blade World</a></h4>
                            </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="blog__item small__item set-bg" data-setbg="img/blog/blog-11.jpg">
                            <img src="../Sources/blog/blog-11.jpg" alt=" " class="blog__item small__item set-bg">
                            <div class="blog__item__text">
                                <p><span class="icon_calendar"></span> 01 March 2020</p>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="blog__item small__item set-bg" data-setbg="img/blog/blog-2.jpg">
                            <img src="../Sources/blog/blog-2.jpg" alt=" " class="blog__item small__item set-bg">
                            <div class="blog__item__text">
                                <p><span class="icon_calendar"></span> 01 March 2020</p>
                                <h4><a href="#">Fate/Stay Night: Untimated Blade World</a></h4>
                            </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="blog__item small__item set-bg" data-setbg="img/blog/blog-3.jpg">
                            <img src="../Sources/blog/blog-3.jpg" alt=" " class="blog__item small__item set-bg">
                            <div class="blog__item__text">
                                <p><span class="icon_calendar"></span> 01 March 2020</p>
                                <h4><a href="#">Building a Better LiA Drilling Down</a></h4>
                            </div>
                    ...
                    <div class="col-lg-12">
                        <div class="blog__item set-bg" data-setbg="img/blog/blog-6.jpg">
                            <img src="../Sources/blog/blog-6.jpg" alt=" " class="blog__item set-bg">
                            <div class="blog__item__text">
                                <p><span class="icon_calendar"></span> 01 March 2020</p>
                                <h4><a href="#">Yuri Kuma Arashi Viverra Tortor Pharetra</a></h4>
                            </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="blog__item small__item set-bg" data-setbg="img/blog/blog-8.jpg">
                            <img src="../Sources/blog/blog-8.jpg" alt=" " class="blog__item small__item set-bg">
                            <div class="blog__item__text">
                                <p><span class="icon_calendar"></span> 01 March 2020</p>
                                <h4><a href="#">Bok no Hero Academia Season 4 – 18</a></h4>
                            </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="blog__item small__item set-bg" data-setbg="img/blog/blog-9.jpg">
                            <img src="../Sources/blog/blog-9.jpg" alt=" " class="blog__item small__item set-bg">
                            <div class="blog__item__text">
                                <p><span class="icon_calendar"></span> 01 March 2020</p>
                                <h4><a href="#">Fate/Stay Night: Untimated Blade World</a></h4>
                            </div>
                    ...
                    <div class="col-lg-12">
                        <div class="blog__item set-bg" data-setbg="img/blog/blog-12.jpg">
                            <img src="../Sources/blog/blog-12.jpg" alt=" " class="blog__item set-bg">
                            <div class="blog__item__text">
                                <p><span class="icon_calendar"></span> 01 March 2020</p>
                                <h4><a href="#">Yuri Kuma Arashi Viverra Tortor Pharetra</a></h4>
                            </div>
