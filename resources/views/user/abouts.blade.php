...
<section class="blog-details spad bg-black">
    <div class="container">
        <div class="row d-flex justify-content-center">
            <div class="col-lg-8">
                <div class="blog__details__title text-black">
                    <h6 > Adventure · Fantasy · Science Fiction. <span>- March 08, 2024</span></h6>
                    <h2 >About Us</h2>
            ...
            <div class="col-lg-12">
                <div class="blog__details__pic">
                    <img src="../Sources/blog-details-pic.jpg" alt="">
                </div>
            </div>
            <div class="col-lg-8">
                <div class="blog__details__content">
                    ...
                    <div class="blog__details__item__text">
                        ...
                        <img src="../Sources/bd-item-1.jpg" alt="">
                    ...
                    <div class="blog__details__item__text">
                        ...
                        <img src="../Sources/bd-item-2.jpg" alt="">
                        <p>In Japan the idea of a first-year speaking to a senior the way Kageyama did to Asahi is a
                            lot more shocking than it would be in the West, but Tobio calling out teammates in
                            genuinely rude fashion in the middle of a match is what got him isolated in the first
                            place.  It’s better for the Crows to sort this out in practice matches than the real
                    ...
                    <div class="blog__details__item__text">
                        <h4>ID:Ianvaded:</h4>
                        <img src="../Sources/bd-item-3.jpg" alt="">
                        <p>In Japan the idea of a first-year speaking to a senior the way Kageyama did to Asahi is a
                            lot more shocking than it would be in the West, but Tobio calling out teammates in
                            genuinely rude fashion in the middle of a match is what got him isolated in the first
                            place.  It’s better for the Crows to sort this out in practice matches than the real
